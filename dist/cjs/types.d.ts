...
export declare type InternalProps<P extends Record<string, any>, S extends Record<string, any> = Record<string, any>> = Required<PropsWithChildren<P & BaseInternalProps<S>>>;
