...
class Slider extends PureComponent {
    ...
    render() {
        ...
        return (<View style={containerStyles} onLayout={this._measureContainer}>
        <View renderToHardwareTextureAndroid style={[styles.track, trackStyle]} onLayout={this._measureTrack}/>
        <Animated.View renderToHardwareTextureAndroid style={[styles.track, minimumTrackStyle]}/>
        <Animated.View renderToHardwareTextureAndroid style={[
                styles.thumb,
                thumbStyle,
